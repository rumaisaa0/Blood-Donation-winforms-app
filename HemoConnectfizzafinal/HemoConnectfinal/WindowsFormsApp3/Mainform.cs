...
namespace WindowsFormsApp3
{
    public partial class Mainform : Form
    {
        ...
        {
            InitializeComponent();
            transfusion1.Visible=inventory1.Visible = donationhistory1.Visible = donors1.Visible = appointment1.Visible=false;
        ...
        private void mainmenu_timer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (mainsidebar.Width >= 200)
                {
                    expandbar = true;
                    mainmenu_timer.Stop();
                    donorbtn.Width = donationbtn.Width = transfusionbtn.Width = inventorybtn.Width = logoutbtn.Width = mainsidebar.Width = 200;
        ...
        private void donorbtn_Click(object sender, EventArgs e)
        {
            ...
            appointment1.Visible = inventory1.Visible = donationhistory1.Visible = false;
        }

        private void donationbtn_Click(object sender, EventArgs e)
        {
            transfusion1.Visible = appointment1.Visible= inventory1.Visible = donors1.Visible = false;
        ...
        {
            appointment1.Visible=inventory1.Visible = donationhistory1.Visible = donors1.Visible = false;
            transfusion1.Visible = true;
        }
        ...
        {
            transfusion1.Visible = inventory1.Visible=donationhistory1.Visible = donors1.Visible = false;
        ...
        {
            transfusion1.Visible = appointment1.Visible=donationhistory1.Visible = donors1.Visible = false;
