    ...
    public partial class Signupform : Form
    {
        ...
        private void signup_signupbtn_Click(object sender, EventArgs e)
        {
            ...
            s_invalidemail.Visible = s_errorpassword.Visible = s_errorpassnotmatch.Visible = 
                s_erroremail.Visible = s_errorusername.Visible =s_invalidage.Visible= s_emptyage.Visible=inany;
            s_underpassword.BackColor = s_underconpass.BackColor = s_underusername.BackColor =s_underage.BackColor=
                    s_underemail.BackColor = Color.FromName("Gray");
            if (signup_username.Text == "")
            {
                s_underusername.BackColor = Color.FromArgb(239, 76, 81);
                s_errorusername.Text = "Username cannot be empty";
                s_errorusername.Visible = inany = true;
            }
            if (signup_username.Text.Length >15)
            {
                s_underusername.BackColor = Color.FromArgb(239, 76, 81);
                s_errorusername.Text = "Username cannot be long than 15";
                s_errorusername.Visible = inany = true;
            }
            if (signup_passwordtxtbox.Text.Length < 6)
            {
                s_underpassword.BackColor = Color.FromArgb(239, 76, 81);
                s_errorpassword.Text = "Atleast 6 characters password";
                s_errorpassword.Visible = inany = true;
            }
            if (signup_passwordtxtbox.Text.Length>15)
            {
                s_underpassword.BackColor = Color.FromArgb(239, 76, 81);
                s_errorpassword.Text = "At max 15 characters password";
                s_errorpassword.Visible = inany = true;
            }
            if (signup_confirmpasswordtxtbox.Text.Length < 6|| signup_confirmpasswordtxtbox.Text.Length >15)
            {
            ...
            if (!IsInteger(agebox.Text.Trim())){
                s_underage.BackColor = Color.FromArgb(239, 76, 81);
                if (agebox.Text == "")
                    s_emptyage.Visible = inany = true;
                else
                {
                    s_invalidage.Text = "Invalid age";
                    s_invalidage.Visible = inany = true; }
            }
            if (IsInteger(agebox.Text.Trim()) && (Convert.ToInt32(agebox.Text.Trim()) < 18 || Convert.ToInt32(agebox.Text.Trim()) > 99))
            {
                s_underage.BackColor = Color.FromArgb(239, 76, 81);
                s_invalidage.Text = "your age not eligible";
                        ...
                        using (SqlCommand checkUser = new SqlCommand(selectUsername, connect))
                        {
                            ...
                            else
                            {
                                ...
                                using (SqlCommand cmd = new SqlCommand(insertData, connect))
                                {
                                    ...
                                    signupdialog dialogForm = new signupdialog("user",signup_username.Text.Trim());
        ...
        {
            Aboutform aform = new Aboutform("signup");
            aform.Show();
            this.Hide();
        }
    }
